...
print '-----------------------------------------'
print 'AST 65416 - CREACION DE VISTAS DE TRABAJO'
print '-----------------------------------------'
...
---------------------------------------
--- CREAR VISTA bc_v_selljujuy_be_1 ---
---------------------------------------
...
create view bc_v_selljujuy_be_1 as
select
...
if @w_n_error != 0
begin
   select @w_d_error = 'ERROR AL CREAR LA VISTA bc_v_selljujuy_be_1'
   
   goto ERROR_TRAP
end
else
   print 'SE CREO CON EXITO LA VISTA bc_v_selljujuy_be_1'

---------------------------------------
--- CREAR VISTA bc_v_selljujuy_be_2 ---
---------------------------------------
...
create view bc_v_selljujuy_be_2 as
select
NRO_OPER    = right(replicate('0',15) + convert(varchar(15),convert(int,ss_identity)),15),
FEC_OPER    = convert(varchar(10),ss_fecha_fv,103),
...
if @w_n_error != 0
begin
   select @w_d_error = 'ERROR AL CREAR LA VISTA bc_v_selljujuy_be_2'
   
   goto ERROR_TRAP
end
else
   print 'SE CREO CON EXITO LA VISTA bc_v_selljujuy_be_2'
